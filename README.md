...
This is a set of scripts that we've written for my games using NeoFPS. Feel free to use them. We'd love for you to contribute to them too. 
...
when adding this code to your project. There are two easy ways you can fix this:
...
A set of actions and conditions plus some sample finite state machines and behaviour trees to provide AI to your characters.
